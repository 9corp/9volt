...
type ICfgUtilDal interface {
	Push(string, map[string][]byte) (int, int, error)
	PushFullConfigs(*cfgutil.FullConfigs) (*CfgUtilPushStats, []string)
}
...
func NewCfgUtil(prefix string, members []string, replace, dryrun, nosync bool) (*CfgUtilDal, error) {
...
func (d *CfgUtilDal) PushFullConfigs(fullConfigs *cfgutil.FullConfigs) (*CfgUtilPushStats, []string) {
